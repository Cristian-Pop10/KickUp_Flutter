  ...
  Future<void> _cargarUsuario() async {
    ...
    setState(() {
      ...
      if (usuario != null) {
        ...
        _posicionController.text = usuario.posicion ?? '';
                        ...
                        Center(
                          child: Column(
                            children: [
                              ...
                              CircleAvatar(
                                radius: 60,
                                backgroundImage: AssetImage(_usuario!.profileImageUrl ?? 'assets/profile.jpg'),
                              ),
                                ...
                                onPressed: () {
                                  setState(() {
                                    ...
                                    if (!_isEditing) {
                                      ...
                                      _posicionController.text = _usuario!.posicion ?? '';
        ...
        _isEditing
            ? TextField(
                ...
                decoration: InputDecoration(
                  filled: true,
                  fillColor: const Color(0xFFE8DFC9), // Color beige claro
                  border: OutlineInputBorder(
            ...
            : Container(
                ...
                decoration: BoxDecoration(
                  color: const Color(0xFFE8DFC9), // Color beige claro
                  borderRadius: BorderRadius.circular(10),
                ),
                child: Text(
                  value,
